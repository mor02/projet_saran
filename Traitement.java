	...
	public Traitement(String filename){
			...
			if (value==false) {
				...
				if (fichier.getExtention().equals("html") || fichier.getExtention().contentEquals("sh")){
					...
					System.out.println("ce n'est ni un html, sh, une image ou un zip");
				}
		...
		public Fichier faireFichier(String filename) {
				...
				fichier.setMime(mimeFichier(filename));
				
				//fichier.setMime("text/html");
				//fichier.setMime("application/x-sh");
				//fichier.setMime("image/png");
				//fichier.setMime("application/vnd.oasis.opendocument.text");
		...
		public String mimeFichier(String filename) {
